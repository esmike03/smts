                        ...
                        <table class="table table-hover" id="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(ucwords($user->user->first_name)); ?></td>
                                    <td><?php echo e($user->user->email); ?></td>
                                    <td><?php echo e($user->user->phone); ?></td>
                                    <td><?php echo e($user->user->type_scholar); ?></td>
                                    <td><?php echo e(@$user->subject->title); ?></td>
                                    <td><?php echo e(@$user->subject->batch); ?></td>
                                    <td><?php echo e(@$user->subject->status); ?></td>
                                    <td>
                                    <a class="profile-action text-info" href="<?php echo e(route('guest.profile', ['id' => $user->user->id])); ?>" title="Profile">
                                        <i class="feather icon-user"></i> 
                                    </a>

                                        <a class="delete-action text-danger" data-id="<?php echo e($user->user->id); ?>" href="javascript:void(0)"  title="Delete">
...
<script>
    ...
    setTimeout(function() {
            ...
            var courses = <?php echo json_encode($courses, 15, 512) ?>;
...
</script><?php /**PATH D:\xampp\htdocs\smts\resources\views/pages/student/index.blade.php ENDPATH**/ ?>