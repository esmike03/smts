                        ...
                        <table class="table table-hover" id="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e(!empty($user->form->created_at) ? date('m/d/Y g:i A', strtotime($user->form->created_at)) : 'Not yet'); ?>

                                    </td>
                                    <td>
                                    <a class="profile-action text-info" href="<?php echo e(route('guest.profile', ['id' => $user->id])); ?>" title="Profile">
                                        <i class="feather icon-user"></i> 
                                    </a>

                                        <a class="delete-action text-danger" data-id="<?php echo e($user->id); ?>" href="javascript:void(0)"  title="Delete">
...
</script><?php /**PATH D:\xampp\htdocs\smts\resources\views/pages/guest/list.blade.php ENDPATH**/ ?>