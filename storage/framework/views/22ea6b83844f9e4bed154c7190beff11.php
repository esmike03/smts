    ...
    <nav class="bg-green-800 border-b-4 border-amber-400 px-4 lg:px-6 z-50 py-2.5 ">
        <div class="flex flex-wrap items-center justify-between mx-auto max-w-screen-xl">
            ...
            <a href="#" class="flex items-center">
                <img src="<?php echo e(asset('assets/images/tesda.png')); ?>" class="h-10 sm:h-12 mr-3 filter invert brightness-0"
                    alt="TESDA Logo" />
            ...
            <div class="flex items-center content-center
             lg:space-x-8 lg:order-2">
                ...
                <a href="<?php echo e(route('profile', ['id' => Auth::user()->id])); ?>"
                    ...
                    <?php echo e(Auth::user()->first_name); ?> (<?php echo e(Auth::user()->type); ?>)
                </a>
...
<?php /**PATH D:\xampp\htdocs\smts\resources\views/layouts/header.blade.php ENDPATH**/ ?>