...
<?php $component->withAttributes([]); ?>
    ...
    <form method="POST" action="<?php echo e(route('student.create')); ?>" class="needs-validation" novalidate
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-1" style="border: solid 1px black;">
                    <div class="text-center">
                        <center>
                            <img class="img-radius" src="<?php echo e(asset('assets/images/tesda.png')); ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 p-1 ">
                            <input type="text" class="form-control" name="email"
                                value="<?php echo e(Auth::user()->email); ?>" required style="border:solid 1px">
                            <label class="d-flex justify-content-center align-items-center font-weight-bold">Email
                                Address/Facebook Account:</label>
                        </div>
                        <div class="col-3 p-1">
                            <input type="number" value="<?php echo e(Auth::user()->phone); ?>" class="form-control"
                ...
                <div class="col-12">
                    <div class="row">
                        <table class="bordered-table">
                            <tbody>
                                <?php $__currentLoopData = $educations->chunk(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td style="text-align: left;">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="educations[]"
                                                        value="<?php echo e($row->id); ?>" type="checkbox"
                                                        id="a_<?php echo e($row->id); ?>">
                                                    <label class="form-check-label"
                                                        for="a_<?php echo e($row->id); ?>"><?php echo e($row->title); ?></label>
                                                </div>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <!-- If less than 4 columns, fill the rest with empty cells -->
                                        <?php for($i = count($chunk); $i < 4; $i++): ?>
                                            <td></td>
                                        <?php endfor; ?>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-12">
                    <div class="row">
                        <table class="bordered-table">
                            <tbody>
                                <?php $__currentLoopData = $classifications->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <!-- Chunk into groups of 4 -->
                                    <tr>
                                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <!-- Iterate over each chunk -->
                                            <td style="text-align: left;">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="classifications[]"
                                                        value="<?php echo e($row->id); ?>" type="checkbox"
                                                        id="b_<?php echo e($row->id); ?>">
                                                    <label class="form-check-label"
                                                        for="b_<?php echo e($row->id); ?>"><?php echo e($row->title); ?></label>
                                                </div>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <!-- If less than 4 columns, fill the rest with empty cells -->
                ...
                <div class="col-12">
                    <div class="row">
                        <table class="bordered-table">
                            <tbody>
                                <?php $__currentLoopData = $disablities->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <!-- Chunk into groups of 4 -->
                                    <tr>
                                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <!-- Iterate over each chunk -->
                                            <td style="text-align: left;">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="type_disabilities[]"
                                                        value="<?php echo e($row->id); ?>" type="checkbox"
                                                        id="c_<?php echo e($row->id); ?>">
                                                    <label class="form-check-label"
                                                        for="c_<?php echo e($row->id); ?>"><?php echo e($row->title); ?></label>
                                                </div>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <!-- If less than 4 columns, fill the rest with empty cells -->
                ...
                <div class="col-12">
                    <div class="row">
                        <table class="bordered-table">
                            <tbody>
                                <?php $__currentLoopData = $causes->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <!-- Chunk into groups of 4 -->
                                    <tr>
                                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <!-- Iterate over each chunk -->
                                            <td style="text-align: left;">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="cause_disabilities[]"
                                                        value="<?php echo e($row->id); ?>" type="checkbox"
                                                        id="d_<?php echo e($row->id); ?>">
                                                    <label class="form-check-label"
                                                        for="d_<?php echo e($row->id); ?>"><?php echo e($row->title); ?></label>
                                                </div>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <!-- If less than 4 columns, fill the rest with empty cells -->
                ...
                <div class="col-12 p-2" style="border: solid 1px black; padding: 1px;background-color:#dddddd">
                    <strong>
                        <h4 style="color: blue; margin: 0;"> 8. Name of Course/Qualification <input type="text"
                                name="qualification" value="<?php echo e($courses->title); ?>"
                ...
                <div class="col-12 p-2" style="border: solid 1px black; padding: 1px;background-color:#dddddd">
                    <strong>
                        <h4 style="color: blue; margin: 0;"> 9. If Scholar, What Type of Scholarship Package (TWSP,
                            PESDA, STEP)? <input name="type_scholar" value="<?php echo e($scholar_type); ?>" readonly
...
<?php /**PATH D:\xampp\htdocs\smts\resources\views/pages/guest/form.blade.php ENDPATH**/ ?>